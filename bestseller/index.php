	...
	<section class="container_content">
    	...
    	<section class="paragraph">
            ...
            <section class="paragraph03 thumbPD" id="newarrival">
                <ul>
					<?php
                    $sql_product = "SELECT * FROM product_tb where best = '1' and ranking not in ('','0') GROUP BY p_color, p_code  ORDER BY best_ranking";
                    ...
                    <li>
						...
						$sql_price .= "p.best = '1' AND p.p_code = '".$data_product['p_code']."' and p.ranking not in ('','0')";
						...
						$sql_color .= "p.best = '1' AND p.p_code = '".$data_product['p_code']."' and p.ranking not in ('','0')";
