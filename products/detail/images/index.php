                    ...
                    <section class="paragraph02" id="detail">
                        ...
                        <section class="blogColor">
                            ...
                            <section>
                                ...
                                $sql_color .= " AND pt.p_color = c.c_code GROUP BY c.c_code ORDER BY pid desc";
                        ...
                        <section class="choiceDetail">
                                ...
                                <select name="pro_id" id="pro_id" onchange="chkPro()">
                                    ...
                                    <?php } ?>
                                </select>  <font color="#FF3399" style="font-family: 'arundina_sansregular'; font-size:16px;">*กรุณาเลือกไซส์สินค้าที่ต้องการ</font>  
                        </section>
                        <?php
...
<section class="paragraph03">
                    ...
                    <section class="paragraph02 hide" id="size">
        ...
        <section class="paragraph03">
		<?php
        $sql_other = "SELECT * FROM product_tb where p_category = '".$data_product['p_category']."' AND p_code = '".$data_product['p_code']."' GROUP BY p_color  ORDER BY pid desc";
