...
if ($_GET['pro_id'] != '' ) {
	...
	$insert_order_product = "INSERT INTO wishlist_product_tb (wishlist_id, u_id, pro_id, pro_code, p_name , p_name_eng, p_category, p_size, p_color";
...
?>
	<script>location='../../wishlist/'</script>
