	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <div class="content_r">
                                	...
                                	<!--Edit Navigator-->
                                   <div class="navigator">
                                        <a href="readytosent2.php">อัพเดท รายการจัดส่ง</a>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px;">     
                      ...
                      <tr>
                       ...
                       <td>เบอร์โทร</td>
                        <td><input type="text" name="order_phone" id="order_phone" value="<?php echo $_GET['order_phone'];?>" /></td>
                      </tr>
                      <tr>
                        <td>จังหวัด</td>
                        <td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table_3cell">
                      ...
                      <?php 
									...
									if( isset($_GET['Search'])){
										 ...
										 $sql_order .= " AND REPLACE(order_phone, '-', '') like '%".$_GET['order_phone']."%'";
