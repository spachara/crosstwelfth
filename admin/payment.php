...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="width:10%" height="25">ชื่อ</td>
    <td style="width:20%"><input type="text" name="name_search" value="<?php echo $_POST['name_search'];?>" /></td>
    <td style="width:10%" align="center">เลขที่ใบสั่งซื้อ</td>
    <td style="width:20%"><input type="text" name="order_number_search" value="<?php echo $_POST['order_number_search'];?>" /></td>
    <td colspan="3" ><font color="#FF0000">*ใส่เฉพาะตัวเลข ไม่ต้องใส่ -IN -PRE</font></td>
    </tr>
  <tr>
    <td style="width:10%" height="25">วันเวลาที่โอน</td>
    <td style="width:20%"><input name="payment_date" type="text" id="datepicker" value="<?php echo $_POST['payment_date'];?>" style="width:100px" /></td>
    <td style="width:10%" align="center">ธนาคาร</td>
    <td style="width:20%"><select name="bank_tranfer" class="validate[required]">
	...
	<td  style="width:10%"align="center">เบอร์โทร</td>
    <td style="width:20%"><input type="text" name="tel" value="<?php echo $_POST['tel'];?>" /></td>
    ...
    <td bgcolor="#000000"><table width="100%" cellpadding="0" cellspacing="1" border="0">
      ...
      <?php 
		...
		if($_POST['Search'] == 'Search'){
		     ...
		     $sql_check .= " AND REPLACE(tel, '-', '') like '%".$_POST['tel']."%'";
		...
		foreach($arrCheck as $key => $e){
			...
			$sql_order_tb = "SELECT order_number, order_status, order_promotion, SUM(order_point) as sum_order_point, SUM(order_transport_status) as sum_tran, order_comment FROM order_tb ";
      ...
      <tr>
        ...
        <a href="order_comment.php?n=<?php echo $data_order_tb['order_number'];?>" target="_blank">  
        <?php if($data_order_tb['order_comment'] == '' ){?>  
