...
if($_POST['Submit'] == 'UPDATE'){
	...
	$add_banner = "UPDATE  promotion_tb SET  promotion_status =  '".$promotion_status."' ,promotion_pass =  '".$_POST['promotion_pass']."' , promotion_dis ='".$_POST['promotion_dis']."' ";
	$add_banner .= "WHERE  promotion_id ='1' ";
...
<body> 
	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <!--Edit Navigator-->
           <div class="navigator">
                <a href="new_promotion.php">Promotion</a>
           </div>
           <!--End Navigator-->            
				...
				<div class="page_conten_r">
                     ...
                     <!--Coppy Module Clear-->
                      ...
                      <?php
                      $sql_promotion = "select * from promotion_tb where promotion_id = '1'";
