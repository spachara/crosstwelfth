                        ...
                        ?>
                                      ...
                                      <tr>
                                        ...
                                        <td width="27%"><select name="order_status" >
                                          ...
                                          <option value="3" <?php echo ($_POST['order_status'] == '3' ? "selected=selected" : "");?>>ค้างส่งสินค้าบางรายการ</option>
                                        ...
                                        <td colspan="2" align="center"><input type="submit" name="Search" id="Search" value="Search" /></td>
                                      </tr>
                                    </table>
                                    <br />
									<?php 
...
<?php echo $data_update3['pro_code']." ".$data_color['name']." ".$data_update3['order_p_size'].$data_product_hand['pro_code'];?></a>
                                        ...
                                        <td align="center" bgcolor="#F5F5F5">
                                         <?php echo "<a href=edit_user.php?u_id=".$data_user['u_id']." target=_blank>".$data_user['u_fname']." ".$data_user['u_lname'];?></a><br /><?php echo $data_user['u_mobi'];?>
                                        </td>
