	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <div class="content_r">
                ...
                <!--Edit Navigator-->
               <div class="navigator">
                    <a href="new_user.php">สมาชิกทั้งหมด</a>
               </div>
               <!--End Navigator-->            
            	...
            	<div class="block_style2">
                	<div class="block_style2_top">
                        ...
                        <div class="block_style2_top-t">สมาชิกทั้งหมด</div>
                    </div>
                                   ...
                                   <!--END form3-->
                                    ...
                                    ?>
                                      <tr>
                                        ...
                                        <td bgcolor="#FFFFFF"><?php echo "<a href=comment_inbox.php?u_id=".$data_user['u_id']." target=_blank><b>".$data_user['u_fname']." ".$data_user['u_lname']."</a></b>";?></td>
                                        <td bgcolor="#FFFFFF"><?php echo $data_user['u_mobi'];?></td>
                                        <td bgcolor="#FFFFFF"><?php echo $data_user['u_mail'];?></td>
                                        <td bgcolor="#FFFFFF"><?php echo $data_user['u_province'];?></td>
                                        <td bgcolor="#FFFFFF"><div class="form2">
                                          <ul>
                                            <li><a href="new_point.php?member_id=<?php echo $data_user['u_id'];?>" target="_blank">Point</a></li>
                                            <li><a href="new_user.php?id_del=<?php echo $data_user['u_id'];?>&amp;sAction=del" onClick="return confirm('Do you want to delete it. (yes/no)')"><img alt="Delete" src="images/1343378039_23-Full Trash.png" title="Delete"/></a></li>
                                            <li><a href="edit_user.php?u_id=<?php echo $data_user['u_id'];?>" target="_blank"><img alt="Edit" src="images/1343377813_Modify.png" title="Edit"/></a></li>
                                          </ul>
                                        </div></td>
                                      </tr>
                                      <?php } ?>
