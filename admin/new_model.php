...
if($_POST['save'] == '1'){
	if($_POST['hidden_new_id']){
		foreach ($_POST['hidden_new_id'] as $v) {
				...
				$update_new_ranking = "UPDATE model_tb SET ranking = '".$_POST['new_ranking'][$v]."'  ";
				$update_new_ranking .= "WHERE mid = '".$_POST['hidden_new_id'][$v]."'";
...
?>		 
		<script>
			location.href='new_model.php'; //รีเฟสหน้า
		</script>
<?php
}

$IMG_ROOT="../images/model/";

if($_GET['sAction'] == 'del'){
	
	$edit_banner = "select picture from model_tb WHERE mid = '".$_GET['id_del']."'";
	...
	$delete_howto = "DELETE FROM model_tb  WHERE mid = '".$_GET['id_del']."' ";
            ...
            <div class="content_r">
            	...
            	<div class="block_style2">
                	<div class="block_style2_top">
                        ...
                        <div class="block_style2_top-t">Model</div>
                    </div>
                    <div class="block_style2_content">
                                   		...
                                   		<!--Coppy Module Clear-->
                                        <form action="new_model.php" method="post" enctype="multipart/form-data" name="form1">
                                        <div class="module_3">
                                            <div class="title">
                                                <div class="l"></div>
                                                <div class="r"></div>
                                   ...
                                   <div class="form3">
                                        ...
                                        <ul>
                                        <li><a href="add_model.php"><img alt="Add" src="images/1343378527_add1-.png" title="Add"/> <span style="position:relative; top:-3px;">Model </span></a></li>                                            
                                   	...
                                   	<div class="table_3cell">
                                     	<ul>
                                            ...
                                            <!--End Title-->
                                            <?php
											$sql_model = "SELECT * FROM model_tb ORDER BY ranking";
											$result_model =$obj->_query($sql_model, $connect);
											$num_model =@mysql_num_rows($result_model);
											
											for($i=1;$i<=intval($num_model);$i++){
                                            ...
                                            <li>
                                              ...
                                              <div class="cell2" style="width:60%;">
                                                ...
                                                <div class="cell3" style="width:20%;">
                                                   ...
                                                   <div class="form2">
                                                        <ul>
                                                            <li><a href="add_model.php?mid=<?php echo $data_model['mid'];?>&amp;sAction=Edit"><img alt="Edit" src="images/1343377813_Modify.png" title="Edit"/></a></li>
                                                            <li><a href="new_model.php?id_del=<?php echo $data_model['mid'];?>&amp;sAction=del" onClick="return confirm('Do you want to delete it. (yes/no)')"><img alt="Delete" src="images/1343378039_23-Full Trash.png" title="Delete"/></a></li>
                                                            <li>Ranking</li>
                                                            <li><input name="new_ranking[<?php echo $data_model['mid'];?>] " type="text" id="new_ranking " size="3" maxlength="3" value="<?php echo $data_model['ranking'];?>">
                                                            <input name="hidden_new_id[<?php echo $data_model['mid'];?>] " type="hidden"  value="<?php echo $data_model['mid'];?>"></li>
                                                        </ul>
                                                   </div>                                   
                                                   <!--End Form2-->
