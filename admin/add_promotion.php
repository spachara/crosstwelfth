...
if($_POST['Submit'] == 'ADD'){
	...
	$add_promotion = "INSERT INTO promotion_tb(promotion_id, promotion_name, promotion_pass, promotion_dis, promotion_status)";
	$add_promotion .= "VALUES(NULL, '".$_POST['promotion_name']."', '".$_POST['promotion_pass']."', '".$_POST['promotion_dis']."', '".$promotion_status."')";
	@mysql_query($add_promotion, $connect);
...
<body> 
	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <!--Edit Navigator-->
           <div class="navigator">
                <a href="new_promotion.php">Promotion CODE</a> > <a href="#">Add Promotion</a>
           </div>
           <!--End Navigator-->            
				...
				<div class="page_conten_r">
                     ...
                     <!--Coppy Module Clear-->
                      ...
                      <?php
                      /*$sql_promotion = "SELECT * FROM promotion_tb ";
