<?php
	...
	$obj = new page_split();
	$obj->_setPageSize(1);						
	$obj->_setFile("comment_webboard.php");		
	...
	if($_POST['Submit']=='EDIT'){
		...
		$sql_answer_webboard = "UPDATE answer_tb SET answer_detail = '".$_POST['webboard_detail']."'";
		$sql_answer_webboard .= " where answer_id = '".$_GET['ans_id']."'";
		@mysql_query($sql_answer_webboard, $connect);
		?>
		<script>location.href='comment_webboard.php?webboard_id=<?php echo $_GET['webboard_id'];?>';</script>
        <?php
	...
	if($_POST['Submit']=='ANSWER' && $_POST['webboard_detail']!=""){
		...
		$sql_answer_webboard = "INSERT INTO answer_tb (answer_id, webboard_id, u_id, answer_detail, date_in)";
		$sql_answer_webboard .= "VALUES(NULL, '".$_GET['webboard_id']."', '0', '".$_POST['webboard_detail']."', NOW() )";
		@mysql_query($sql_answer_webboard, $connect);
		?>
		<script>location.href='comment_webboard.php?webboard_id=<?php echo $_GET['webboard_id'];?>';</script>
        <?php
	...
	if($_GET['sAction'] == 'del'){
		...
		$sql_delete_slide = "delete from answer_tb  where answer_id = '$_GET[id_del]' ";
	...
	$sql_answer = "SELECT * FROM answer_tb WHERE webboard_id = '".$_GET['webboard_id']."' ORDER BY answer_id";
	$result_answer =$obj->_query($sql_answer, $connect);
	...
	$sql_ans = "SELECT * FROM answer_tb WHERE answer_id = '".$_GET['ans_id']."' ";
                                   ...
                                   <form name="form1" method="post">
                                    ...
                                    <div class="table_3cell">
                                     	<ul>        
                                               ...
                                               <div class="edit">                                              
                                                <a href="comment_webboard.php?id_del=<?php echo $data_answer['answer_id'];?>&amp;sAction=del" onClick="return confirm('Do you want to delete it. (yes/no)')"><img alt="Delete" src="images/1343378039_23-Full Trash.png" title="Delete"/></a>
                                                </div>
                                                <div class="edit">
                                                <li><a href="comment_webboard.php?ans_id=<?php echo $data_answer['answer_id'];?>&webboard_id=<?php echo $_GET['webboard_id'];?>&amp;sAction=EDIT"><img alt="Edit" src="images/1343377813_Modify.png" title="Edit"/></a></li>
                                                </div><br />
                                            <?php 
												echo "<b>ข้อความที่ $com</b> วันที่ ".$day."/".$month."/".$year." เวลา ".$hour.":".$minute.":".$second." น. <br><br>";
