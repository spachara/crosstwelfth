...
if($_GET['delfile'] != '' ){
	$edit_banner = "UPDATE model_tb SET picture='' where mid='".$_GET['mid']."'";
	@mysql_query($edit_banner, $connect);
	@unlink($_GET['delfile']);
	?><script>window.location.href='add_model.php?mid=<?php echo $_GET['mid'];?>&sAction=Edit';</script><?php
}
...
if($_POST['Submit'] == 'CREATE'){
	...
	$add_banner = "INSERT INTO model_tb (mid, name, picture, ranking, date_in)";
	$add_banner .= "VALUES(NULL, '".$_POST['name']."', '".$pic_name."', '0', NOW())";
	@mysql_query($add_banner, $connect);
			

?><script>window.location.href='new_model.php';</script>
<?php } 


if($_POST['Submit'] == 'Edit'){

	$add_banner = "UPDATE model_tb SET name = '".$_POST['name']."'";
	$realname = $_FILES['uploadedfile1']['name'];  
	...
	$add_banner .= " where mid = '".$_POST['mid']."'";
	@mysql_query($add_banner, $connect);
...
$sql_model = "select * from model_tb where mid = '".$_GET['mid']."'";
...
<body> 
	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <!--Edit Navigator-->
           <div class="navigator">
                <a href="new_model.php">Model</a> < <a href="#"><?php echo ($_GET['sAction'] == 'Edit' ? "Edit" : "Add" );?> Model</a>
           </div>
           <!--End Navigator-->            
            	...
            	<div class="block_style2">
                	<div class="block_style2_top">
                        ...
                        <?php echo ($_GET['sAction'] == 'Edit' ? "Edit" : "Add" );?> Model
                        </div>
                    </div>
                ...
                <input type="hidden" name="pic_hidden" value="<?php echo $data_model['picture'];?>" />
                      ...
                      <div class="table_3cell">
                          <ul>
                                 <li>
                                    ...
                                    <div class="cell3-input"><input name="name" type="text" id="name" value="<?php echo $data_model['name'];?>" /></div>
                                </li>
                                <li>
                              	  <div class="cell3-text">Picture Model : </div>                                
                                  <div class="cell3-input"><input name="uploadedfile1" type="file" id="uploadedfile1" ></div>
                                </li>
                                <?php if($data_model['picture']){?>
                                 <li>
                              	  <div class="cell3-text">Picture Model : </div>                                
                                  <div class="cell3-slidehome">
                                  <img src="<?php echo $IMG_ROOT.$data_model['picture'];?>" width="160"/>
                                  <br />
                                  <a href="add_model.php?mid=<?php echo $data_model['mid'];?>&delfile=<?php echo $IMG_ROOT.$data_model['picture'];?>" onClick="return confirm('Do you want to delete it. (yes/no)')">[ DELETE PICTURE ]</a>
                                  </div>
                                </li>
                                <?php } ?>
