<?php
	...
	$obj = new page_split();
	$obj->_setPageSize(5);						
	$obj->_setFile("new_bank.php?bank_type=".$_GET['bank_type']);		
	...
	if($_POST['save'] == '1'){
			...
			foreach ($_POST['hidden_new_id'] as $v) {
					...
					$update_new_ranking = "UPDATE bank_tb SET ranking= '".$_POST['new_ranking'][$v]."'  ";
	...
	if($_GET['sAction'] == 'del'){
		...
		$sql_bank_del = "SELECT * FROM bank_tb WHERE bid = '".$_GET['id_del']."' ";
		$result_bank_del =@mysql_query($sql_bank_del, $connect);
		$data_bank_del =@mysql_fetch_array($result_bank_del);

		@unlink("../images/bank/".$data_bank_del['picture']);	

		$sql_delete_banner = "DELETE FROM bank_tb  WHERE bid = '".$_GET['id_del']."' ";
		@mysql_query($sql_delete_banner, $connect);
		

	?><script>window.location.href='new_bank.php'; //รีเฟสหน้า</script><?
	
}
	$sql_banner = "SELECT * FROM bank_tb ORDER BY ranking";
	$result_banner =@mysql_query($sql_banner, $connect);
	$num_banner =@mysql_num_rows($result_banner);
		
	$IMG_ROOT="../images/bank/";
	$bank_name = "ธนาคาร";
        ...
        <div class="container_content">
            ...
            <div class="content_r">
                                   ...
                                   <div class="navigator">
                                        ...
                                        <a href="new_bank.php"><?php echo $bank_name;?></a>
                                     	...
                                     	<ul>
                                            ...
                                            <li>
                                                ...
                                                <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo $IMG_ROOT;?><?php echo $data_banner['picture'];?>">
                                                	<img src="<?php echo $IMG_ROOT;?><?php echo $data_banner['picture'];?>" width="70" height="70"/>
												...
												?>
                                                    ...
                                                    <td width="83%" valign="top"><?php echo "<br>".$data_banner['name']."<br>".$data_banner['detail'];?></td>
                                                  </tr>
                                                </table>
                                                ...
                                                <div class="cell3-slidehome" >
                                                   ...
                                                   <div class="form2">
                                                        <ul>
                                                           ...
                                                           <li><a href="new_bank.php?id_del=<?php echo $data_banner['bid'];?>&sAction=del" onClick="return confirm('Do you want to delete it. (yes/no)')"><img alt="Delete" src="images/1343378039_23-Full Trash.png" title="Delete"/></a></li>
                                                             
                                                           <li><a href="add_bank.php?bid=<?php echo $data_banner['bid'];?>&amp;sAction=Edit"><img alt="Edit" src="images/1343377813_Modify.png" title="Edit"/></a></li>
