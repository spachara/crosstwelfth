...
if($_POST['save'] == '1'){
	if($_POST['hidden_new_id']){
		foreach ($_POST['hidden_new_id'] as $v) {
				...
				$update_new_ranking = "UPDATE supplier_tb SET ranking = '".$_POST['new_ranking'][$v]."'  ";
...
?>		 
		<script>
			location.href='new_supplier.php'; //รีเฟสหน้า
		</script>
<?php
}
...
if($_GET['sAction'] == 'del'){
	$delete_howto = "DELETE FROM supplier_tb  WHERE sid = '".$_GET['id_del']."' ";
        ...
        <div class="container_content">
          ...
          <?php include('mainmenu.php');?>
            ...
            <div class="content_r">
                                	...
                                	<!--Edit Navigator-->
                                   <div class="navigator">
                                     <a href="new_supplier.php">Supplier</a>
            	...
            	<div class="block_style2">
                	<div class="block_style2_top">
                        ...
                        <div class="block_style2_top-t">Supplier</div>
                    </div>
                    <div class="block_style2_content">
                                   		...
                                   		<!--Coppy Module Clear-->
                                        <form action="new_supplier.php" method="post" enctype="multipart/form-data" name="form1">
                                        <div class="module_3">
                                            <div class="title">
                                                <div class="l"></div>
                                                <div class="r"></div>
                                   ...
                                   <div class="form3">
                                        ...
                                        <ul>
                                        <li><a href="add_supplier.php"><img alt="Add" src="images/1343378527_add1-.png" title="Add"/> <span style="position:relative; top:-3px;">Supplier </span></a></li>                                            
                                   	...
                                   	<div class="table_3cell">
                                     	<ul>
                                        	...
                                        	<li class="bg-title">
                                              ...
                                              <div class="cell2" style="width:20%; height:25px;">รหัส</div>
                                              <div class="cell3" style="width:20%; height:25px;">ชื่อ</div>
                                              <div class="cell3" style="width:20%; height:25px;">เบอร์โทร</div>
                                              <div class="cell3" style="width:20%;">&nbsp;</div>
                                            </li>
                                            <!--End Title-->
                                            <?php
											$sql_category = "SELECT * FROM supplier_tb ORDER BY ranking";
                                            ...
                                            <li>
                                                ...
                                                <?php echo $data_category['s_code']; ?>
                                                </div>	
                                                <div class="cell3" style="width:20%;">
                                                <?php echo $data_category['s_name']; ?>
                                                </div>	
                                                <div class="cell3" style="width:20%;">
                                                <?php echo $data_category['s_tel']; ?>
                                                </div>	
                                                ...
                                                <div class="cell3" style="width:20%;">
                                                   ...
                                                   <div class="form2">
                                                        <ul>
                                                            <li><a href="add_supplier.php?sid=<?php echo $data_category['sid'];?>&amp;sAction=Edit"><img alt="Edit" src="images/1343377813_Modify.png" title="Edit"/></a></li>
                                                            <li><a href="new_supplier.php?id_del=<?php echo $data_category['sid'];?>&amp;sAction=del" onClick="return confirm('Do you want to delete it. (yes/no)')"><img alt="Delete" src="images/1343378039_23-Full Trash.png" title="Delete"/></a></li>
                                                            <li>Ranking</li>
                                                            <li><input name="new_ranking[<?php echo $data_category['sid'];?>] " type="text" id="new_ranking " size="3" maxlength="3" value="<?php echo $data_category['ranking'];?>">
                                                            <input name="hidden_new_id[<?php echo $data_category['sid'];?>] " type="hidden"  value="<?php echo $data_category['sid'];?>"></li>
                                                        </ul>
                                                   </div>                                   
                                                   <!--End Form2-->
