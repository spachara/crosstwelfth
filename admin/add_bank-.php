...
if($_GET['delfile'] != '' ){
	$edit_banner = "UPDATE bank_tb SET picture='' where bid='".$_GET['bid']."'";
	@mysql_query($edit_banner, $connect);
	@unlink($_GET['delfile']);
	?><script>window.location.href='add_bank.php?bid=<?php echo $_GET['bid'];?>&sAction=Edit';</script><?php
}
...
if($_POST['Submit'] == 'CREATE'){
	...
	$add_banner = "INSERT INTO bank_tb (bid, name, picture, detail, ranking, date_in)";
	$add_banner .= "VALUES(NULL, '".$_POST['name']."', '".$pic_name."', '".$_POST['detail']."', '0', NOW())";
	@mysql_query($add_banner, $connect);
			

?><script>window.location.href='new_bank.php';</script>
<?php } 


if($_POST['Submit'] == 'Edit'){

	$add_banner = "UPDATE bank_tb SET name = '".$_POST['name']."', detail = '".$_POST['detail']."'";
	$realname = $_FILES['uploadedfile1']['name'];  
...
$sql_banner = "select * from bank_tb where bid = '".$_GET['bid']."'";
...
<body> 
	...
	<div class="shadow_r"></div>  
        ...
        <div class="container_content">
            ...
            <!--Edit Navigator-->
           <div class="navigator">
                <a href="new_bank.php">Banner</a> < <a href="#"><?php echo ($_GET['sAction'] == 'Edit' ? "Edit" : "Add" );?> Banner</a>
           </div>
           <!--End Navigator-->            
                     ...
                     <!--Coppy Module Clear-->
                      ...
                      <div class="table_3cell">
                          <ul>
                                ...
                                <li>
                              	  <div class="cell3-text">Picture  : </div>                                
                                ...
                                <?php if($data_banner['picture']){?>
                                 <li>
                                  ...
                                  <br />
                                  <a href="add_bank.php?bid=<?php echo $data_banner['bid'];?>&delfile=<?php echo $IMG_ROOT.$data_banner['picture'];?>" onClick="return confirm('Do you want to delete it. (yes/no)')">[ DELETE PICTURE ]</a>
                                  </div>
                                </li>
                                <?php } ?>
                                 <li>
                                    ...
                                    <?php
                                            ...
                                            $oFCKeditor->Value		= $data_banner['detail'] ;
                                            $oFCKeditor->Create() ;
                                    ?>    
