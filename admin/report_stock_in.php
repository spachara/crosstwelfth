            ...
            <div class="content_r">
            	...
            	<div class="block_style2">
                	<div class="block_style2_top">
                        ...
                        <div class="block_style2_top-t">สรุปรายการสิ้นค้าเข้า</div>
                    </div>
         	...
         	<br />               
                ...
                <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="10%" height="20" align="center" bgcolor="#F7F7F7">ลำดับ</td>
                                        <td colspan="3" width="25%" align="center" bgcolor="#F7F7F7">Product</td>
                                        <td width="20%" align="center" bgcolor="#F7F7F7">Make</td>
                                        <td width="20%" align="center" bgcolor="#F7F7F7">ของเข้า</td>
                                        <td width="25%" align="center" bgcolor="#F7F7F7">Date in</td>
                                      </tr>
                                      <?php 
                                      if($_POST['submit'] == 'Submit' ){
                                      $sql_select_stock = "select distinct c.name as color_name, p.p_code, p.p_size, ut.* from update_stock_tb as ut inner join product_tb as p on ut.pid=p.pid inner join color_tb as c on c.c_code = p.p_color where  ut.date_in between   '".$_POST['date_begin'] ."%'  AND '".$_POST['date_finish'] ." 23:59:59.999' order by ut.date_in desc";
                                      ...
                                      <tr>
                                        ...
                                        <td  width="50" align="left" bgcolor="#F7F7F7"><?php echo $data_select_stock['p_code']; ?></td>
                                         <td width="50"  align="left" bgcolor="#F7F7F7"><?php echo  $data_select_stock['color_name']; ?></td>
                                         <td width="49"  align="left" bgcolor="#F7F7F7"><?php echo  $data_select_stock['p_size']; ?></td>
                                        ...
                                        ?>
                                        <tr>
                                        <td height="20" align="center" bgcolor="#DEDEDE"><?php echo $u; ?></td>                                        
                                        <td  width="50"align="left" bgcolor="#DEDEDE"><?php echo $data_select_stock['p_code']; ?></td>
                                         <td width="50" align="left" bgcolor="#DEDEDE"><?php echo  $data_select_stock['color_name']; ?></td>
                                         <td  width="49" align="left" bgcolor="#DEDEDE"><?php echo  $data_select_stock['p_size']; ?></td>
                                        <td align="center" bgcolor="#DEDEDE"><?php echo $data_select_stock['make']; ?></td>
                                        <td align="center" bgcolor="#DEDEDE"><?php echo $data_select_stock['real_recive']; ?></td>
                                        <td align="center" bgcolor="#DEDEDE"><?php echo $data_select_stock['date_in']; ?></td>
                                      </tr>
                                      <?php 
                                          }
                                      }
