...
if($_POST['type']=='chk_order'){
	...
	$select_order = "SELECT SUM(order_total) as total_order, SUM(order_transport_status) as sum_tran, order_promotion, order_point, u_id FROM order_tb WHERE order_number = '".$ex_order_2[0]."' and order_number_rank = '".$ex_order_2[1]."' ";
