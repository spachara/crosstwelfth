                            	...
                            	<div class="choice-tabel">
                                    ...
                                    ?>
                                    	<li>
											...
											<?php echo ($grand_num > 1 && $data_ship['shipping_id'] == '1' ? "disabled=disabled" : "" );?> 
                                            value="<?php echo $data_ship['shipping_id'];?>" 
											<?php echo ($_SESSION['shipping']==$data_ship['shipping_id'] || ($_SESSION['shipping'] == '' && $s =='1') || 
											($grand_num > 1 && $data_ship['shipping_id'] == 2)? "checked=checked" : '');?>/>
