...
if($_SESSION['session_id']){
			...
			$insert_order .= " , order_type_pay, order_employee, order_email, order_phone, order_group, link_url , date_in, date_update)";
			...
			$insert_order .= " , '', '".mysql_real_escape_string($_SESSION['cus_phone'])."', '".$pro_group."', '" . $link . "' , NOW(), NOW() )"; 
...
$cost_ship = $_SESSION['session_realShipPre'];
			...
			$insert_order2 .= " , order_type_pay, order_employee, order_email, order_phone, order_group, link_url , date_in, date_update)";
			...
			$insert_order2 .= " , '', '".mysql_real_escape_string($_SESSION['cus_phone'])."', '".$pre_group."' , '" . $link . "' , NOW(), NOW() )"; 
