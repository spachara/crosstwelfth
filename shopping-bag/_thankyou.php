...
require("../class.phpmailer.php");
		...
		$view_total = number_format($grang_total_pre).".".$sub_mit;
			...
			$mail->AddBCC("pitchaya@thetreedesign.com", "Pitchaya");
    	...
    	<section class="paragraph">
            ...
            <section class="paragraph03">
				<section class="blogOrder">
                    ...
                    <center><p>ระบบได้จัดส่งใบสั่งซื้อให้ท่านแล้ว <br /><br />
                    กรุณาตรวจสอบ Inbox รวมทั้ง Junk Box ของ E-mail ของท่าน</p>
                    <p>สินค้าที่สั่งซื้อจะบันทึกในระบบ เพื่อรอชำระเงิน 2 วัน     กรุณาชำระเงินและแจ้งชำระเงินภายใน 2 วัน เพื่อรักษาสถานะใบสั่งซื้อนี้นะคะ<br /><br />
                    </p>
                    <p>ใบสั่งซื้อของท่าน  หมายเลข 
					<?php echo ($_SESSION['order_id'] != '' ? "<a href='../tmp/".$_SESSION['order_id']."-"."IN.pdf' target='_blank'>".$_SESSION['order_id']."-"."IN</a>" : "");?> 
					<?php echo ($_SESSION['order_pre_id'] != '' ? " และ <a href='../tmp/".$_SESSION['order_pre_id']."-"."PRE.pdf' target='_blank'>".$_SESSION['order_pre_id']."-"."PRE</a>" : "");?></p>
                    <p>หากมีข้อสงสัย ติดต่อ ทีมงาน ได้ที่ 02 4056562 หรือ 081 380 2212 หรือส่งข้อความมาพูดคุยกับทีมงาน  โดยกดที่ลิงค์นี้ได้เลยคะ <br /></p>
                    
                    <p>
                    เพื่อความรวดเร็วใจการตรวจสอบยอดเงินโอน และการจัดส่งสินค้า<br />
                    กรุณานำเลขท้าย 2 ตัวของใบเลขที่ใบสั่งซื้อมาใส่เป็นเศษสตางค์ในการโอนเงิน<br />
                    รวมยอดเงินที่ี่ต้องชำระของคุณคือ <font color="#FF0000" size="+2"><?php echo $view_total;?></font> บาท<br />
                    </p>
                    
                    <p>ขอบคุณที่ไว้วางใจให้ Crosstwelfth ได้บริการลูกค้า นะคะ<br /><br />
                    </p></center>
            </section>		
          </section>
        </section>
