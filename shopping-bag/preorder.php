...
$member_sql = "SELECT *  FROM user_tb WHERE u_id = '".$_SESSION['AUTH_PERMISSION_MEMID']."'";
$member_results = mysql_query($member_sql, $connect);
$member_data = mysql_fetch_array($member_results);
}
...
if ($_POST['complete'] == "Login") {
	...
	if ($num_user == 1) {
		...
		echo "<script>location.href='preorder.php'</script>";
	}else{?>
	<script type="text/javascript">
		$(document).ready(function() {
			$.fancybox({
...
if($_POST['sub'] == '1' ){
					...
					session_register('check_address');
					...
					$_SESSION['check_address']=$_POST['chk1'];
					...
					$_SESSION['cus_member_datacountry2'] = $_POST['contact_country2'];
...
include('../include/header.php') ?>
	...
	<section class="container_content">
    	...
    	<section class="paragraph overflowNone">
            ...
            <?php if ($_SESSION['AUTH_PERMISSION_MEMID'] == "") {?>
             ...
             <form method="post" id="formID1" name="formID1" action="preorder.php">
 ...
 <form method="post" id="formID2" name="formID2" action="confirm.php" >
                	...
                	<section class="addressUser">
                    	<section class="addressUser-l">
                        	<ul>
                            	...
                            	<li>
                                    ...
                                    <h6>
                                    <?php if($_SESSION['sess_language'] == 'eng'){ ?>
                                    <input name="contact_name" id="contact_name" type="text" class="validate[required]" value="<?php echo ($_SESSION['cus_name'] == '' ? $member_data['u_fname']: $_SESSION['cus_name']);?>"/>
                                    <?php }else{ ?>
                                    <input name="contact_name" id="contact_name" type="text" class="validate[required]" value="<?php echo ($_SESSION['cus_name'] == '' ? $member_data['u_fname']: $_SESSION['cus_name']);?>"/>
                                    <?php } ?>
                                    </h6>
                                ...
                                <li>
                                    ...
                                    <h6>
									<?php if($_SESSION['sess_language'] == 'eng'){ ?>
                                    <input name="contact_surname" id="contact_surname" type="text" class="validate[required]" value="<?php echo ($_SESSION['cus_lname'] == '' ? $member_data['u_lname']: $_SESSION['cus_lname']);?>"/>
                                    <?php }else{ ?>
                                    <input name="contact_surname" id="contact_surname" type="text" class="validate[required]" value="<?php echo ($_SESSION['cus_lname'] == '' ? $member_data['u_lname']: $_SESSION['cus_lname']);?>"/>
                                    <?php } ?>
                                    </h6>
                                ...
                                <li>
                                    ...
                                    <h6>
                                    <textarea name="contact_address" id="contact_address" cols="" rows="" class="validate[required]"><?php echo ($member_data['u_add']=='' ? $_SESSION['cus_address']: $member_data['u_add']);?></textarea>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                  ...
                                  <h6>
                                                <select name="contact_province" id="contact_province" class="validate[required]">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $data_country['PROVINCE_NAME'];?>" <?php echo (($member_data['u_province'] == $data_country['PROVINCE_NAME']) || ($_SESSION['cus_province2'] == $data_country['PROVINCE_NAME'] ) ? "selected=selected" : "");?>><?php echo $data_country['PROVINCE_NAME'];?></option>
                                                    <?php } ?>
                                                </select>                                    
                                ...
                                <li>
                                    ...
                                    <h6>
                                    <input name="contact_zipcode" id="contact_zipcode" class="validate[required]" type="text" value="<?php echo ($member_data['u_zipcode']=='' ? $_SESSION['cus_zipcode']: $member_data['u_zipcode']);?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    ...
                                    <h6>
                                    <input name="contact_phone" id="contact_phone" class="validate[required]" type="text" value="<?php echo ($member_data['u_mobi']=='' ? $_SESSION['cus_phone']: $member_data['u_mobi']);?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    ...
                                    <h6>
                                    <input name="contact_email" id="contact_email" type="text" value="<?php echo ($member_data['u_mail']=='' ? $_SESSION['cus_email']: $member_data['u_mail']);?>" class="validate[required,custom[email]]" />
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                            </ul>
                        ...
                        <section class="addressUser-r">
                        	<ul>
                                ...
                                <li>
                                	<h4>
                                      <input name="chk1" type="checkbox" onClick="movetochk2(this.value);" <?php echo ($_SESSION['check_address'] == '1' ? "checked=checked" : "");?> value="1"/>
                                      <label><?php echo ($_SESSION['sess_language']=='eng' ? 'SAME AS BILLING ADDRESS' : 'ที่อยู่เดียวกันกับที่อยู่ออกบิล' );?></label>
                                    <div class="clear"></div>
                                    </h4>
                                </li>
                            	<li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'Name' : 'ชื่อ' );?> :</label>
                                    <h6>
                                    <input name="contact_name2" id="contact_name2" type="text" class="validate[required]" value="<?php echo ($_POST['contact_name2'] == '' ? $_SESSION['cus_name2'] : $_POST['contact_name2'] );?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'Surname' : 'นามสกุล' );?> :</label>
                                    <h6>
                                    <input name="contact_surname2" id="contact_surname2" type="text" class="validate[required]" value="<?php echo ($_POST['contact_surname2'] == '' ? $_SESSION['cus_lname2']: $_POST['contact_surname2']);?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'Address' : 'ที่อยู่' );?> :</label>
                                    <h6>
                                    <textarea name="contact_address2" id="contact_address2" cols="" rows="" class="validate[required]"><?php echo ($_POST['contact_address2']=='' ? $_SESSION['cus_address2']: $_POST['contact_address2']);?></textarea>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'Province' : 'จังหวัด' );?> :</label>
                                    <h6>
                                                <select name="contact_province2" id="contact_province2" class="validate[required]">
                                                    <option value="">กรุณาเลือกจังหวัด</option>
                                                    <?php 
                                                    $select_country = "SELECT * FROM province order by PROVINCE_NAME";
                                                    $result_country =@mysql_query($select_country, $connect);
                                                    ...
                                                    $data_country =@mysql_fetch_array($result_country);	
                                                    ?>
                                                    <option value="<?php echo $data_country['PROVINCE_NAME'];?>" <?php echo ($_SESSION['cus_province2'] == $data_country['PROVINCE_NAME'] ? "selected=selected" : "");?>><?php echo $data_country['PROVINCE_NAME'];?></option>
                                                    <?php } ?>
                                                </select>                                    
                                ...
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'ZIP/POSTAL CODE' : 'รหัสไปรษณีย์' );?> :</label>
                                    <h6>
                                    <input name="contact_zipcode2" id="contact_zipcode2" type="text" class="validate[required]" value="<?php echo ($_POST['contact_zipcode2']=='' ? $_SESSION['cus_zipcode2']: $_POST['contact_zipcode2']);?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'PHONE NUMBER' : 'เบอร์โทรศัพท์' );?> :</label>
                                    <h6>
                                    <input name="contact_phone2" id="contact_phone2" type="text" class="validate[required]" value="<?php echo ($_POST['contact_phone2']=='' ? $_SESSION['cus_phone2']: $_POST['contact_phone2']);?>"/>
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                                <li>
                                    <label>* <?php echo ($_SESSION['sess_language']=='eng' ? 'EMAIL' : 'อีเมล์' );?> :</label>
                                    <h6>
                                    <input name="contact_email2" id="contact_email2" type="text" value="<?php echo ($_POST['contact_email2']=='' ? $_SESSION['cus_email2']: $_POST['contact_email2']);?>" class="validate[required,custom[email]]" />
                                    </h6>
                                	<div class="clear"></div>
                                </li>
                            </ul>
