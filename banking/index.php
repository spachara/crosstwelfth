<?php
	...
	$sql_banking = "SELECT * FROM txt_tb WHERE type_name = 'banking'";
	$result_banking =@mysql_query($sql_banking, $connect);
	$data_banking =@mysql_fetch_array($result_banking);
	...
	<section class="container_content">
    	...
    	<section class="paragraph overflowNone">
            ...
            <section class="paragraph03">
				<?php 
                echo ($_SESSION['sess_language'] == 'eng' ? $data_banking['txt_detail_eng'] : $data_banking['txt_detail_th']);
                ?>
            </section>
            <div class="clear"></div>
        </section>
