                    ...
                    <fieldset>
                    	<ul>
                            ...
                            <li>
                                ...
                                <input name="u_pass" type="text" id="u_pass" class="validate[required,minSize[4],maxSize[10]]" value="<?php echo $data_user['u_pass'];?>"/>
                            	<div class="clear"></div>
                            </li>
                            <li>
                            	<label>Re-enter Password (ยืนยันรหัสผ่าน)*</label>
                                <input name="u_repassword" type="text" id="u_repassword" class="validate[required, equals[u_pass]]" value="<?php echo $data_user['u_pass'];?>"/>
                            	<div class="clear"></div>
                            </li>
                            <li>
                            	<label>Email Address (อีเมล์)*</label>
                                <input name="view_mail" type="text" value="<?php echo $data_user['u_mail']!='' ? $data_user['u_mail'] : $_SESSION['r_mail'] ;?>" disabled="disabled"/>
