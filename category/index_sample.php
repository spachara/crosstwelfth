	...
	<section class="container_content">
    	...
    	<section class="paragraph">
            <hgroup class="titleModule">
                <h2><?php echo $_GET['c'];?></h2>
            </hgroup>        
            <section class="paragraph03 thumbPD" id="newarrival">
                <ul>
					<?php
                    $sql_product = "SELECT * FROM product_tb where p_category = '".$_GET['c']."' and ranking not in ('','0') GROUP BY p_color, p_code  ORDER BY pid desc";
                    ...
                    <li>
						...
						$sql_color .= "p.p_category = '".$data_product['p_category']."' AND p.p_code = '".$data_product['p_code']."'";
