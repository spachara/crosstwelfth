<?php
	...
	$sql_howto = "SELECT * FROM txt_tb WHERE type_name = 'Howto'";
	$result_howto =@mysql_query($sql_howto, $connect);
	$data_howto =@mysql_fetch_array($result_howto);
	...
	<section class="container_content">
    	...
    	<section class="paragraph overflowNone">
            ...
            <section class="paragraph03">
				<?php 
                echo ($_SESSION['sess_language'] == 'eng' ? $data_howto['txt_detail_eng'] : $data_howto['txt_detail_th']);
                ?>
            </section>
            <div class="clear"></div>
        </section>
