<?php
	...
	$sql_delivery = "SELECT * FROM txt_tb WHERE type_name = 'Delivery'";
	$result_delivery =@mysql_query($sql_delivery, $connect);
	$data_delivery =@mysql_fetch_array($result_delivery);
	...
	<section class="container_content">
    	...
    	<section class="paragraph overflowNone">
            ...
            <section class="paragraph03">
				<?php 
                echo ($_SESSION['sess_language'] == 'eng' ? $data_delivery['txt_detail_eng'] : $data_delivery['txt_detail_th']);
                ?>
            </section>
            <div class="clear"></div>
        </section>
