	...
	<section class="container_content">
    	...
    	<section class="paragraph">
            ...
            <section class="paragraph03 thumbPD" id="newarrival">
                <ul>
					<?php
                    $sql_product = "SELECT * FROM product_tb as p where ranking not in ('','0') and p_stock > 0 GROUP BY p_color, p_code  ORDER BY pid desc";
